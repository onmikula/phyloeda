# Function:
#	max_crosssection: partitioning of a rooted tree by the maximum cross-section branch length criterion
# Argument:
#	phy: tree in an object of class 'phylo' or 'hclust'
# Value:
#	data frame with components 'Tips' (tree tips) and 'Group' (partitions they are classified into)
