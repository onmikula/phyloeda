...
phylomap <- function(info, color, subset, ind, lin, gps, border="black", size=4, lwd=1, map=NULL, device, width=7, height=7, file=NULL, mai=0.02, xlim, ylim, axes=TRUE, cex.axis=1.25, legend=TRUE, expr) {
