...
#' 
#' @param coords a data frame with individual identifier (e.g., `ID` column) and geographical coordinates,
#'   whose names are partial matches of "latitude", "longitude" or "x", "y").
#' @param class a data frame with individual identifier (1st column) and classification into groups (2nd column)
#'   supposed to be phylogenetic lineages, species, clades...
#' @param ind a name of individual identifier (e.g. "ID").
#' @param group a name of group identifier (e.g. "Species").
#' @param color a named vector of point colors, names must correspond to group labels.
...
#' @param expr an expression (or a list of them) allowing to add other elements (e.g. legend).
#' @export
