...
loci <- read_ipyrad("data/georychus10K.alleles")

# possibly you can get rid off sequence repeats using this custom function (but it is computationally demanding)
